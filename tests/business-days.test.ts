...
it.each([
 ['2026-09-21T19:00:00Z','2026-09-28'], ['2026-09-25T19:00:00Z','2026-10-02'],
 ['2026-09-26T19:00:00Z','2026-10-02'], ['2026-03-06T20:00:00Z','2026-03-13'],
 ['2026-09-26T02:00:00Z','2026-10-02'],
])('Tijuana %s permits %s',(now,result)=>expect(earliestEventLocalDate(new Date(now))).toBe(result))
...
it('inverse deadline includes weekend submission',()=>expect(latestRegistrationLocalDate('2026-10-03')).toBe('2026-09-27'))
